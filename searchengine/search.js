...
if (searchValue === "") {
    errorMessage("Search cannot be empty,please enter a serch term.");
...
function displayResults(results){
    ...
    results.query.search.forEach((result) =>{
        ...
        <a href="${resultURL}" target="blank"
rel="noopener" class="h3 fw-bold">${result.title}</a>
<br>
<a href="" target="blank"
rel="noopener" class="fs-5 text-success">${resultURL} </a>
